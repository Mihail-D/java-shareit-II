...
public class BookingController {
    ...
    @GetMapping
    public List<BookingOutDto> getAllBookingsByBookerId(
    ...
    @PostMapping
    public BookingOutDto addBooking(
            @RequestHeader(HEADER_USER) Long userId,
    ...
    public BookingOutDto approveBooking(
            @RequestHeader(HEADER_USER) Long userId,
            @PathVariable Long bookingId,
    ...
    @GetMapping("/owner")
    public List<BookingOutDto> getAllBookingsForAllItemsByOwnerId(
            @RequestHeader(HEADER_USER) Long userId,
            @RequestParam(defaultValue = "ALL", required = false) String state
    ) {
